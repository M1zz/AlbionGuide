...
struct ArmorListView: View {
        ...
        NavigationStack {
            ZStack {
                ...
                if viewModel.isLoading && viewModel.armors.isEmpty {
                    ProgressView(String(localized: "loading_armor"))
            ...
            .navigationTitle(String(localized: "armor"))
            .searchable(text: $viewModel.searchText, prompt: String(localized: "search_armor"))
    ...
    private var categoryFilterMenu: some View {
        Menu(String(localized: "category")) {
...
struct ArmorDetailView: View {
    ...
    var body: some View {
        ...
        .navigationTitle(viewModel.armor.localizedName)
    ...
    private var armorHeader: some View {
        VStack(spacing: 12) {
            ...
            Text(viewModel.armor.localizedName)
                .font(.title2.bold())
    ...
    private var spellsContent: some View {
        VStack(spacing: 16) {
            if viewModel.spellSlots.isEmpty {
                Text(String(localized: "no_skills"))
                    .foregroundStyle(.secondary)
                    .padding()
            } else {
...
struct ArmorSpellSlotSection: View {
    ...
    var slotName: String {
        switch slot.slot {
        case "First Slot": return String(localized: "d_skill")
